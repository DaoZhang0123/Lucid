...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            sidecar::skill_set_enabled,
            sidecar::skill_repo_list,
            sidecar::skill_repo_add,
            sidecar::skill_repo_delete,
            sidecar::skill_repo_set_enabled,
            sidecar::skill_repo_refresh,
            sidecar::skill_repo_search,
            sidecar::skill_repo_install,
